...
[`emulator_uitest_run.ps1`](LocalScripts/emulator_uitest_run.ps1): script to run
...
go into the `LocalScripts` folder and run `emulator_uitest_run.ps1`.  You'll
...
Similarly,
[`emulator_uitest_run.ps1`](LocalScripts/emulator_uitest_run.ps1) is in a
...
TODO: `runOptions: '--test-output-dir "$(appCenterOutputDir)"'` and
`nunit_xml_zip.zip`.
